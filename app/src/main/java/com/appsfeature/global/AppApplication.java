...
//        getLoginSDK();
    ...
    private Response.Callback<UserModel> mNewAddressCallback;

    public void setNewAddressCallback(Response.Callback<UserModel> callback) {
        this.mNewAddressCallback = callback;
    }

    public void pushAddressUpdateCallbacks(UserModel userModel) {
        if(mNewAddressCallback != null){
            mNewAddressCallback.onSuccess(userModel);
        }
    }
}
