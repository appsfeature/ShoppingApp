...
import com.appsfeature.global.adapter.RelativeProductAdapter;
...
public class ProductDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getDataFromServer(property.getSub_cat());
        getrela();
    }
    ...
    private void initUi() throws JSONException {
        ...
        relative_recy = findViewById(R.id.relative_recy);
        ...
        relative_recy.setAdapter(adapter);
