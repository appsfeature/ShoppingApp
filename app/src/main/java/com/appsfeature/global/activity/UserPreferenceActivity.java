    ...
    private void initUi() {
        ...
        findViewById(R.id.btn_submit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!FieldValidation.isEmpty(view.getContext(), mSelectedCountryCode, "Please select Country")){
                    return;
                }
                ...
                AppPreference.setCountry(mSelectedCountryCode);
        ...
        if(countryName != null && countryName.size() > 0) {
            ...
            spCountry.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                    mSelectedCountryCode = countryCodes.get(position);
                }
