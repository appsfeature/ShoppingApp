 ...
 */
public class AppSelectionSwitch {
    ...
    public interface Listener{
        void onSwitchChanged(boolean isFirstChecked);
    }

    public AppSelectionSwitch(View tvSwitch1, View tvSwitch2) {
        this.tvSwitch1 = tvSwitch1;
        this.tvSwitch2 = tvSwitch2;
        addSwitchListener();
    }

    public void addSwitchChangeListener(Listener listener) {
    ...
    public AppSelectionSwitch setSelected(boolean isFirstSelected) {
