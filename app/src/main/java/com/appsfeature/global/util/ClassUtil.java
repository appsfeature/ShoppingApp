...
import com.appsfeature.global.activity.BookingSuccessActivity;
...
//                intent.putExtra(AppConstant.EXTRA_PROPERTY, loginType);
    ...
    public static void openActivityOrderSummary(Activity activity, CartModel cartModel) {
        ExtraProperty extraProperty = new ExtraProperty();
        extraProperty.setTitle("Order Summary");
        extraProperty.setCartModel(cartModel);
        activity.startActivity(new Intent(activity, OrderSummaryActivity.class)
                .putExtra(AppConstant.CATEGORY_PROPERTY, extraProperty));
    }

    public static void openActivityAddAddress(Activity activity, Response.Callback<UserModel> callback) {
        ExtraProperty extraProperty = new ExtraProperty();
        extraProperty.setTitle("New Address");
        AppApplication.getInstance().setNewAddressCallback(callback);
        activity.startActivity(new Intent(activity, NewAddressActivity.class)
                .putExtra(AppConstant.CATEGORY_PROPERTY, extraProperty));
    }

    public static void openActivityPaymentSuccess(Activity activity, ExtraProperty property, CartModel cartModel) {
        ExtraProperty extraProperty = property.getClone();
        extraProperty.setCartModel(cartModel);
    ...
    public static void openActivityOrderHistory(Activity activity) {
        activity.startActivity(new Intent(activity, OrderHistoryActivity.class));
    }

    public static void openActivityProfile(Activity activity) {
