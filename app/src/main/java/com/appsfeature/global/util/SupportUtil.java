...
//            intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public static void showNoDataRetry(View view, NetworkCallback.Retry retryCallback) {
        showNoDataRetry(view, retryCallback, null);
    }

    public static void showNoDataRetry(View view, NetworkCallback.Retry retryCallback, Response.Progress progress) {
        if (view != null) {
